...
object Constants {
    ...
    const val INTENT_SECONDARY_DNS = INTENT_PREFIX + "DNS2"
    ...
    const val INTENT_BYPASS_LAN = INTENT_PREFIX + "BYPASSLAN"
    const val INTENT_KILL_SWITCH = INTENT_PREFIX + "KILLSWITCH"
    const val INTENT_IP_TYPE = INTENT_PREFIX + "IPTYPE"
    const val INTENT_DOMAIN_MODE = INTENT_PREFIX + "DOMAINMODE"
    const val INTENT_DOMAIN_LIST = INTENT_PREFIX + "DOMAINLIST"
